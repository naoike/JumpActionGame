...
public class GameScreen extends ScreenAdapter {
    ...
    List<Step> mSteps;
    List<Star> mStars;
    List<Enemy> mEnemies;  //課題　追加
    Sound mSound = Gdx.audio.newSound(Gdx.files.internal("enemy.mp3"));
    Ufo mUfo;
    Player mPlayer;
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mEnemies = new ArrayList<Enemy>();   //課題　追加
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.naoki.ikegami.jumpactiongame");
